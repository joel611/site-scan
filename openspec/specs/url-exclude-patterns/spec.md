...
Defines the default URL path exclusion list and the glob matching logic applied during crawl. URLs whose pathnames match any active pattern are skipped before enqueue.
