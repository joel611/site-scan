# High-Indegree Edge Filter

## Purpose

Filters out edges to nodes that are linked from a disproportionately large number of pages (e.g., global nav links), reducing noise in the graph and keeping stats focused on meaningful content connections.
