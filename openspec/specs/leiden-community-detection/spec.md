...
Runs Leiden community detection on the directed link graph after construction, assigning each node a `community` string id and merging small singleton communities into a shared `"c-other"` group.
