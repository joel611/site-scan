# Header/Footer Link Filtering

## Purpose

TBD - Excludes links found in sitewide chrome elements (header, footer, nav) from outbound link extraction, so the site graph reflects content-level relationships rather than navigation structure.
