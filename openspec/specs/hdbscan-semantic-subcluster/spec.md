# HDBSCAN Semantic Subcluster

## Purpose

Runs HDBSCAN on embedding vectors within each Leiden community to produce fine-grained semantic subclusters, assigning each node a `subcluster` string id or `null` for noise points.
